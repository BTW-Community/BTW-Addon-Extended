...
public class NetClientHandler extends NetHandler
{
    ...
    {
        double var2 = (double)par1Packet26EntityExpOrb.posX / 32.0D;
        double var4 = (double)par1Packet26EntityExpOrb.posY / 32.0D;
        double var6 = (double)par1Packet26EntityExpOrb.posZ / 32.0D;
        EntityXPOrb var8 = new EntityXPOrb(this.worldClient, var2, var4, var6, par1Packet26EntityExpOrb.xpValue, par1Packet26EntityExpOrb.m_bNotPlayerOwned);
        var8.serverPosX = par1Packet26EntityExpOrb.posX;
        var8.serverPosY = par1Packet26EntityExpOrb.posY;
        var8.serverPosZ = par1Packet26EntityExpOrb.posZ;
        var8.rotationYaw = 0.0F;
        var8.rotationPitch = 0.0F;
        var8.entityId = par1Packet26EntityExpOrb.entityId;
        this.worldClient.addEntityToWorld(par1Packet26EntityExpOrb.entityId, var8);
    }
    ...
    public void handleWeather(Packet71Weather par1Packet71Weather)
    {
        ...
        {
            var8 = new FCEntityLightningBolt(this.worldClient, var2, var4, var6);
        }
    ...
    public void handleFlying(Packet10Flying par1Packet10Flying)
    {
        ...
        if (!this.doneLoadingTerrain)
        {
            ...
            this.m_bAwaitingChunkLoadToDisableGUIScreen = true;
            this.m_iUpdatesSinceTerrainLoaded = 0;
        }
    }
    ...
    public void handleOpenWindow(Packet100OpenWindow par1Packet100OpenWindow)
    {
        ...
        switch (par1Packet100OpenWindow.inventoryType)
        {
            ...
            case 7:
                TileEntityBeacon var6 = new TileEntityBeacon();
            ...
            case 9:
                TileEntityHopper var7 = new TileEntityHopper();
            ...
            case 10:
                TileEntityDropper var8 = new TileEntityDropper();
    ...
    public void handleGameEvent(Packet70GameEvent par1Packet70GameEvent)
    {
        ...
        if (var3 == 7)
        {
            ...
            if (var4 == 0)
            {
                this.worldClient.prevThunderingStrength = this.worldClient.thunderingStrength = 0.0F;
            }
            else
            {
                this.worldClient.prevThunderingStrength = this.worldClient.thunderingStrength = 1.0F;
            }
        }
        else if (var3 == 8)
        {
    ...
    public void handleEntityEffect(Packet41EntityEffect par1Packet41EntityEffect)
    {
        ...
        if (var2 instanceof EntityLiving)
        {
            ...
            PotionEffect var4 = new PotionEffect(par1Packet41EntityEffect.effectId, par1Packet41EntityEffect.duration, par1Packet41EntityEffect.effectAmplifier, var3);
            var4.setPotionDurationMax(par1Packet41EntityEffect.isDurationMax());
            ((EntityLiving)var2).addPotionEffect(var4);
        }
    }
    ...
    public void handleCustomPayload(Packet250CustomPayload par1Packet250CustomPayload)
    {
        ...
        else if (!AddonExtHandler.interceptCustomClientPacket(this.mc, par1Packet250CustomPayload))
        {
    ...
    {
        if (this.m_bAwaitingChunkLoadToDisableGUIScreen)
        {
            if (this.IsTerrainAroundPlayerLoaded())
            {
                ++this.m_iUpdatesSinceTerrainLoaded;

                if (this.m_iUpdatesSinceTerrainLoaded > 20)
                {
                    this.doneLoadingTerrain = true;
                    this.mc.displayGuiScreen((GuiScreen)null);
                    this.m_bAwaitingChunkLoadToDisableGUIScreen = false;
                }
            }
            else
            {
    ...
    {
        int var1 = (int)this.mc.thePlayer.posX;
        int var2 = (int)this.mc.thePlayer.posZ;
        byte var3 = 48;

        for (int var4 = var1 - var3; var4 <= var1 + var3; var4 += 16)
        {
            for (int var5 = var2 - var3; var5 <= var2 + var3; var5 += 16)
            {
                Chunk var6 = this.worldClient.getChunkFromBlockCoords(var4, var5);

                if (!var6.isChunkLoaded)
                {
                    return false;
                }
            }
